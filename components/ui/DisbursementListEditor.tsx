...
export const DisbursementListEditor: React.FC<Props> = ({ disbursements = [], onChange, readOnly = false }) => {
    const handleAdd = () => {
        if (readOnly) return;
                        ...
                        >
                            <div className="flex-1 grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            type="date"
                                            value={disb.date}
                                            onChange={(e) => handleUpdate(disb.id, { date: e.target.value })}
                                            disabled={readOnly}
                                ...
                                <div>
                                    ...
                                    <input
                                        type="number"
                                        value={disb.amount === 0 ? '' : disb.amount}
                                        onChange={(e) => handleUpdate(disb.id, { amount: parseFloat(e.target.value) || 0 })}
                                        disabled={readOnly}
