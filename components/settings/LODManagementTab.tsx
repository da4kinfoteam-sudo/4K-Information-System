                                                                        ...
                                                                        <div className="flex-1">
                                                                            ...
                                                                            <div className="mb-2">
                                                                                <input 
                                                                                    ...
                                                                                    className={`w-full text-sm text-gray-500 dark:text-gray-400 bg-transparent border-b border-transparent ${!lockedQuestionIds.has(question.id) ? 'hover:border-gray-300 focus:border-emerald-500' : ''} focus:outline-none italic`}
                                                                                />
                                                                            </div>
